    ...
    */
    ...
    initTextures() {
        ...
        for (var id in textures) {
            ...
            this.textures[id] = new CGFtexture(this, texture);
    ...
    initMaterials() {
        ...
        for (var id in materials) {
            ...
            var shininess = this.graph.shininess;
            var emission = material[0];
            var ambient = material[1];
            var diffuse = material[2];
            var specular = material[3];
