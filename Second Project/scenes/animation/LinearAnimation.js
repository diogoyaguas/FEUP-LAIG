...
class LinearAnimation extends Animation {
    ...
    calculateAngle(p1, p2) {
        ...
        var vMag1 = Math.sqrt(vector1[0] * vector1[0] + vector1[1]* vector1[1] + vector1[2]* vector1[2]);
        var vMag2 = Math.sqrt(subtractedPoints[0] * subtractedPoints[0] + subtractedPoints[1]* subtractedPoints[1] + subtractedPoints[2]* subtractedPoints[2]);

        var v1 = [vector1[0] / vMag1, vector1[1] / vMag1, vector1[2] / vMag1];
        var v2 = [subtractedPoints[0] / vMag2, subtractedPoints[1] / vMag2, subtractedPoints[2] / vMag2];
